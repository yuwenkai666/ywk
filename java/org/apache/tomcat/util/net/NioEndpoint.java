...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    /**
     * Generic properties, introspected 通用属性 自检反射
     */
    @Override
    ...
    public class Poller implements Runnable {
        ...
        public void run() {
            ...
            //System.out.println("============================sockets轮询器停止===============================");
     ...
     * external Executor thread pool.线程池的工作实例
     */
    protected class SocketProcessor extends SocketProcessorBase<NioChannel> {
        ...
        protected void doRun() {
            ...
            try {
                ...
                try {
                    if (key != null) {
                        if (socket.isHandshakeComplete()) {//百分百的返回true 
                ...
                if (handshake == 0) {
                    ...
                    if (event == null) {
                        state = getHandler().process(socketWrapper, SocketEvent.OPEN_READ);//责任链模式交给下一级处理
                    } else {
