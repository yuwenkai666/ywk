...
public class CachedResource implements WebResource {
	...
	public String toString() {
		return "CachedResource [cache=" + cache + ", root=" + root + ", webAppPath=" + webAppPath + ", ttl=" + ttl
				+ ", objectMaxSizeBytes=" + objectMaxSizeBytes + ", webResource=" + webResource + ", webResources="
				+ Arrays.toString(webResources) + ", nextCheck=" + nextCheck + ", cachedLastModified="
				+ cachedLastModified + ", cachedLastModifiedHttp=" + cachedLastModifiedHttp + ", cachedContent="
				+ Arrays.toString(cachedContent) + ", cachedIsFile=" + cachedIsFile + ", cachedIsDirectory="
				+ cachedIsDirectory + ", cachedExists=" + cachedExists + ", cachedIsVirtual=" + cachedIsVirtual
