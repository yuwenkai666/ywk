...
public class JspServletWrapper {
		...
		if (reload) {
			synchronized (this) {
				...
				if (reload) {
					...
					theServlet = servlet;
					reload = false;
					// Volatile 'reload' forces in order write of 'theServlet' and new servlet
					// object
				}
			}
		}
	...
	/**
	 * Sets the last-modified time of the servlet class file associated with this
	 * JspServletWrapper.
	 *
	 * @param lastModified
	...
	/**
	 * Compile and load a prototype for the Tag file. This is needed when compiling
	 * tag files with circular dependencies. A prototype (skeleton) with no
	 * dependencies on other other tag files is generated and compiled.
	 * 
	 * @return the loaded class
	 * @throws JasperException
	 *             Error compiling or loading tag file
	 ...
	 * number in the JSP. Then constructs an exception containing that information,
	 * and a snippet of the JSP to help debugging. Please see
